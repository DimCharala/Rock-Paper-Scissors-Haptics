...
def main():
    ...
    gestures = ['rock', 'paper', 'scissors']#, 'pron', 'supi'] # Classes to acquire data for
    trials_n = 200  # Number of trials for each class
    trial_len = 3 # Duration of each trial in seconds
